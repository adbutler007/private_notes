#!/usr/bin/env python3
"""
Model Comparison Test: qwen3:4b vs qwen3:1.7b

Tests the complete pipeline (Parakeet transcription + summarization)
with both LLM models to compare output quality and speed.
"""
...
def transcribe_audio_file(audio_path: str, model_path: str = "mlx-community/parakeet-tdt-0.6b-v3") -> str:
...
def test_model(
    ...
    """Test summarization with a specific model"""
    print("="*80)
    ...
    # Simulate chunking (in real use, this happens during recording)
    # For this test, we'll treat the whole transcript as one chunk
...
def compare_models(metrics_4b: Dict, metrics_1_7b: Dict):
    ...
    print("QWEN3:1.7B (Smaller - 1.4GB):")
